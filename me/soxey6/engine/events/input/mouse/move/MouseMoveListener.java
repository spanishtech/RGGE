...
public class MouseMoveListener extends EventListener{
	...
	public boolean fitsFilter(Event event)
	{
		if(isStrictFiltering())
			return (((MouseMoveEvent) event).getX()==((MouseMoveEvent)getEventFilter()).getX()&&((MouseMoveEvent) event).getY()==((MouseMoveEvent)getEventFilter()).getY()||((MouseMoveEvent) event).getDx()==((MouseMoveEvent)getEventFilter()).getDx()&&((MouseMoveEvent) event).getDy()==((MouseMoveEvent)getEventFilter()).getDy());
		else
